    ...
    return (
        <View style={styles.container}>
            <ImageBackground source={require("../../assets/images/backpng.png")} resizeMode='stretch' style={{ flex: 1, gap: 30 }}>
                <View style={{ flex: 2, justifyContent: "top", alignItems: "center", padding: 20 }}><Text style={{ fontSize: 25, fontFamily: "DeliusUnicase-Bold", color: "#333e54" }}>AKTÜEL ÜRÜNLER</Text></View>
